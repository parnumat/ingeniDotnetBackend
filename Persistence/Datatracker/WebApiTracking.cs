...
namespace Persistence.DataTracker
{
    public class WebApiTracking
    {
        ...
        public static void SendToSignalRWithTimeUsed(UserJwt user, string header, string body, string footer, Stopwatch stopwatch, DateTime timeStart, DateTime timeEnd)
        {
            if (string.IsNullOrEmpty(user.TrackingStatus))
                return;
